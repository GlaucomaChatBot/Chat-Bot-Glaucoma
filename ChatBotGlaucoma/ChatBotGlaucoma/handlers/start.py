...
async def start_handler(message: Message):
    ...
    if not patient and not doctor:
        await message.answer(
            "Добро пожаловать в бот Glaucoma!♥\nЭтот бот поможет пациентам принимать вовремя их препараты, а врачам контролировать прием лекарств их пациентов.💊\nПодскажите, Вы врач или пациент?",
